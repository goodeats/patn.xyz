...
import { z } from 'zod'
import { ErrorList, Field, Icon, StatusButton } from '#app/components/index.ts'
import {
	prepareVerification,
...
export async function action({ request }: ActionFunctionArgs) {
	...
	const response = await sendEmail({
		...
		subject: `PatN XYZ Email Change Verification`,
...
export function EmailChangeEmail({
	...
	return (
		<E.Html lang="en" dir="ltr">
			<E.Container>
				<h1>
					<E.Text>PatN XYZ Email Change</E.Text>
				</h1>
				<p>
					<E.Text>
...
export function EmailChangeNoticeEmail({ userId }: { userId: string }) {
	return (
		<E.Html lang="en" dir="ltr">
			<E.Container>
				<h1>
					<E.Text>Your PatN XYZ email has been changed</E.Text>
				</h1>
				<p>
					<E.Text>
						We're writing to let you know that your PatN XYZ email has been
						changed.
					</E.Text>
				</p>
				<p>
